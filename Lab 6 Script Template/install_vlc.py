...
def main():
    ...
    if installer_ok(installer_data, expected_sha256):
        ...
        print("Error: Hash values do not match")
...
def get_expected_sha256():
    ...
    expected_sha256_url = 'http://download.videolan.org/pub/videolan/vlc/3.0.17.4/win64/vlc-3.0.17.4-win64.exe.sha256'
    resp_msg = requests.get(expected_sha256_url)
